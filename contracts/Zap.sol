...
interface IFantohmBondDepository {
    function deposit( uint _amount, uint _maxPrice, address _depositor) external returns ( uint );
}

contract FantohmZapIn is ZapInBaseV3_1 {
    using SafeERC20 for IERC20;

    mapping (IFantohmBondDepository => address) public allowedPairs;
    mapping (IFantohmBondDepository => address) public allowedReserves;
   ...
   constructor(address _DAO)
    {
        DAO = _DAO;
        // 0x exchange
        approvedTargets[0xDEF189DeAEF76E379df891899eb5A00a94cBC250] = true; //fantom 0x

        //allowedPairs
        //fhm-dai lp
        allowedPairs[IFantohmBondDepository(0x7a5523342bBAFC43184f85805d0bACc68f2F3Df1)] = 0xd77fc9c4074b56Ecf80009744391942FBFDDd88b; //fantom

        //allowedReserves
        //dai
        allowedReserves[IFantohmBondDepository(0x462eEC9f8A067f13B5F8F7356D807FF7f0e28c68)] = 0x8D11eC38a3EB5E956B052f67Da8Bdc9bef8Abf3E;  //fantom
        //mim
        allowedReserves[IFantohmBondDepository(0x3C1a9b5Ff3196C43BcB05Bf1B7467fbA8e07EE61)] = 0x82f0B8B456c1A451378467398982d4834b6829c1;  //fantom
        
        //sSpell
        allowedReserves[IFantohmBondDepository(0x6D0a19bBBA84Cc2fE3cB05b4D9a9Aaf52fE9Df63)] = 0xbB29D2A58d880Af8AA5859e30470134dEAf84F2B;  //fantom
        //wFTM
        allowedReserves[IFantohmBondDepository(0x6b5eC972A3d44d3da19258e96CCAa9826641b8A1)] = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;  //fantom
        //FUSD
        allowedReserves[IFantohmBondDepository(0xc7C64C8A27F1c52C0EecAF4542d3b100f5e27a27)] = 0x18F7f88BE24a1d1d0a4E61B6Ebf564225398adb0;  //fantom
    }
    ...
    function addPairAddress(address bondDepository, address pair) external onlyOwner {
        ...
        allowedPairs[IFantohmBondDepository(bondDepository)] = pair;
    ...
    function removePairAddress(address bondDepository) external onlyOwner {
        ...
        allowedPairs[IFantohmBondDepository(bondDepository)] = address(0);
    ...
    function addReserveAddress(address bondDepository, address reserve) external onlyOwner {
        ...
        allowedReserves[IFantohmBondDepository(bondDepository)] = reserve;
    ...
    function removeReserveAddress(address bondDepository) external onlyOwner {
        ...
        allowedReserves[IFantohmBondDepository(bondDepository)] = address(0);
        emit RemoveReserveAddress(bondDepository);
    }

    /**
    @notice Add liquidity to spookyswap pools with ETH/ERC20 Tokens and buys Fantohm Bond
    ...
    function ZapInLp(
        ...
        IFantohmBondDepository _bondDepository,
        uint256 _amount,
        ...
        cache.balanceAfter = _FromTokenContractAddress == address(0) 
            ? IERC20(wftmTokenAddress).balanceOf(address(this))
            : IERC20(_FromTokenContractAddress).balanceOf(address(this));
    ...
    function _fillQuote(
        ...
        if (_swapTarget == wftmTokenAddress) {
            IWETH(wftmTokenAddress).deposit{ value: _amount }();
            return _amount;
        }
    ...
    function _fillQuoteLp(
        ...
        if (_swapTarget == wftmTokenAddress) {
            IWETH(wftmTokenAddress).deposit{ value: _amount }();
            return (_amount, wftmTokenAddress);
        }
