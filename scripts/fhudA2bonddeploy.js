...
async function main() {
    ...
    // Deploy Bond
    const Bond = await ethers.getContractFactory('FhudA2BondDepository');
    const bond = await Bond.deploy( fhmAddress, fhudAddress, reserve.address, treasury.address, daoAddress, fhudMinterAddress, uniswapFactoryAddress, uniswapRouterAddress);
