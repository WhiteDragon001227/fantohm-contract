...
async function main() {
    ...
    const {
        ...
        treasuryAddress,
        usdbMinterAddress,
        spookyPoolRouterAddress,
        lqdrUsdbLpTokenAddress,
        xFhmAddress,
    ...
    const bond = await Bond.deploy(fhmAddress, usdbAddress, reserve.address, treasury.address, daoAddress, usdbMinterAddress, spookyPoolRouterAddress, lqdrUsdbLpAddress, xFhmAddress, treasuryHelperAddress);
    await bond.deployed();
